...
\textbf{\begin{tabular}[c]{@{}c@{}}Audio\\ Finger-\\ printing\end{tabular}} & \begin{tabular}[c]{@{}c@{}}Exact audio \\ (degraded)\\ is detected\end{tabular}           & \begin{tabular}[c]{@{}c@{}}Only query \\ audio \\ is present\end{tabular}                           \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}Cover Song\\ Detection\end{tabular}}     & \begin{tabular}[c]{@{}c@{}}Cover is not \\ exactly same audio\\ as reference\end{tabular} & \begin{tabular}[c]{@{}c@{}}Cover contains \\ modifications in\\ structure, instruments\end{tabular} \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}Sample\\ Detection\end{tabular}}         & \begin{tabular}[c]{@{}c@{}}Exact sample \\ is present,\\ possibly modified\end{tabular}   & \begin{tabular}[c]{@{}c@{}}Sample is present \\ in a mixture\\ of audio tracks\end{tabular}         \\ \hline
\end{tabular}
\caption{Comparison Table of Related Work}
\end{table}
...
The \tabref{results} report the accuracy of our classifier on the test data. %Note that we compute the metrics using the probability threshold for classification as 0.5.
